...
def build_professional_out(professional: Professional) -> ProfessionalOut:
    ...
    return ProfessionalOut(
        ...
        salon_street=getattr(professional, "salon_street", None),
        salon_number=getattr(professional, "salon_number", None),
        salon_complement=getattr(professional, "salon_complement", None),
        salon_zipcode=getattr(professional, "salon_zipcode", None),
